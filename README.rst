...
.. image:: https://travis-ci.org/prodamspsites/procon.portal.svg
    :target: https://travis-ci.org/prodamspsites/procon.portal

O estado atual da cobertura de testes pode ser acompanhado pela imagem abaixo:

.. image:: https://coveralls.io/repos/prodamspsites/procon.portal/badge.svg
    :target: https://coveralls.io/r/prodamspsites/procon.portal 
...
1. Editar o arquivo buildout.cfg (ou outro arquivo de configuração) e
   adicionar o pacote ``procon.portal`` à lista de eggs da instalação::
