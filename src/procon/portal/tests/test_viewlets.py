# -*- coding: utf-8 -*-
from procon.portal.browser.viewlets.analytics import AnalyticsViewlet
from procon.portal.browser.viewlets.logo import LogoViewlet
from procon.portal.testing import INTEGRATION_TESTING
